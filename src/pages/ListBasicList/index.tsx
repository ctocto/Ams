...
interface ListBasicListProps extends FormComponentProps {
  listBasicList: StateType;
  dispatch: Dispatch<any>;
  loading: boolean;
}
interface ListBasicListState {
  visible: boolean;
  done: boolean;
  current?: Partial<BasicListItemDataType>;
}

class ListBasicList extends Component<
  ListBasicListProps,
  ListBasicListState
> {
  state: ListBasicListState = { visible: false, done: false, current: undefined };
                  ...
                  <List.Item
                    actions={[
                      ...
                      <a
                        ...
                        onClick={e => {
                          e.preventDefault();
                          router.push(`/profileadvanced?id=${item.id}`);
                        }}
                      >
                        详情
                      </a>,
